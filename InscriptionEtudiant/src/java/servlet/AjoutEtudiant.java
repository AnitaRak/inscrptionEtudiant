...
public class AjoutEtudiant extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           java.sql.Date daty = new java.sql.Date(parsedDate.getTime());
          
           HibernateDAO hi = new HibernateDAO();
           Etudiant e = new Etudiant(nom,prenom,daty,adresse);
           hi.insert(e);
           response.sendRedirect("listeEtudiant.jsp");
           
           //String nom, String prenom, Date date_naissance, String adresse
